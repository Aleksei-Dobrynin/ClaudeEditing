...
export const schema = yup.object().shape({
  ...
  structure_employee_id: yup.number().notOneOf([0], "Обязательное поле").required("Обязательное поле"),
  application_task_id: yup.number().notOneOf([0], "Required field").required("Required field"),
});
