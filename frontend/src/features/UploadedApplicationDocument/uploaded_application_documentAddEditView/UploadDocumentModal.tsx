...
export const UploadDocumentModal: FC<UploadDocumentModalProps> = observer((props) => {
  ...
  const handleSubmit = async () => {
    ...
    setIsLoading(true);
    try {
      store.onSaveClick((id) => {
        handleClose();
        props.onSaveClick(id)
      }, props.step_id, file, file.name, comment)
      // props.onSaveTemplateClick(() => {
