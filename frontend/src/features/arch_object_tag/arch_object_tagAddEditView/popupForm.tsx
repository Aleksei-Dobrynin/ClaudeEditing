...
import Arch_object_tagAddEditBaseView from './base';
...
const Arch_object_tagPopupForm: FC<PopupFormProps> = observer((props) => {
  ...
  return (
    <Dialog open={props.openPanel} onClose={props.onBtnCancelClick} maxWidth="sm" fullWidth>
      <DialogTitle>{translate('label:arch_object_tagAddEditView.entityTitle')}</DialogTitle>
      <DialogContent>
...
export default Arch_object_tagPopupForm
