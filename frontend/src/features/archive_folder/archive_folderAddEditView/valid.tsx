...
export const schema = yup.object().shape({
  ...
  archive_folder_name: yup.string().required("Обязательное поле"),
  dutyplan_object_id: yup.number().notOneOf([0], "Required field").required("Required field"),
  folder_location: yup.string(),
  // created_at: yup
  //   .date()
  //   .nullable()
