...
import storeList from "./../archive_folderListView/store";
...
const FastInputView: FC<archive_folderProps> = observer((props) => {
  ...
  return (
    <Container>
      <Card component={Paper} elevation={5}>
        <CardContent>
          <Box id="archive_folder_TitleName" sx={{ m: 1 }}>
            <h3>{translate("label:archive_folderAddEditView.entityTitle")}</h3>
          </Box>
          <Divider />
                    ...
                    {storeList.isEdit === false && (
                      <>
                        ...
                        <IconButton
                          ...
                          onClick={() => storeList.deletearchive_folder(entity.id)}
                        >
                          <DeleteIcon />
                        </IconButton>
                      </>
            ...
            <Grid container spacing={3} sx={{ mt: 2 }}>
              ...
              <Grid item md={12} xs={12}>
                <LookUp
                  ...
                  label={translate('label:archive_folderAddEditView.dutyplan_object_id')}
              ...
              <Grid item md={12} xs={12}>
                <CustomTextField
                  value={store.folder_location}
                  onChange={(event) => store.handleChange(event)}
                  name="folder_location"
                  data-testid="id_f_archive_folder_folder_location"
                  id='id_f_archive_folder_folder_location'
                  label={translate('label:archive_folderAddEditView.folder_location')}
                  helperText={store.errors.folder_location}
                  error={!!store.errors.folder_location}
                />
              </Grid>
              <Grid item md={12} xs={12}>
                <DateTimeField
                  ...
                  onChange={(event) => store.handleChange(event)}
                  name="created_at"
                  id='id_f_archive_folder_created_at'
                  label={translate('label:archive_folderAddEditView.created_at')}
              ...
              <Grid item md={12} xs={12}>
                <DateTimeField
                  ...
                  onChange={(event) => store.handleChange(event)}
                  name="updated_at"
                  id='id_f_archive_folder_updated_at'
                  label={translate('label:archive_folderAddEditView.updated_at')}
              ...
              <Grid item md={12} xs={12}>
                <CustomTextField
                  ...
                  onChange={(event) => store.handleChange(event)}
                  name="created_by"
                  data-testid="id_f_archive_folder_created_by"
                  id='id_f_archive_folder_created_by'
                  label={translate('label:archive_folderAddEditView.created_by')}
              ...
              <Grid item md={12} xs={12}>
                <CustomTextField
                  ...
                  onChange={(event) => store.handleChange(event)}
                  name="updated_by"
                  data-testid="id_f_archive_folder_updated_by"
                  id='id_f_archive_folder_updated_by'
                  label={translate('label:archive_folderAddEditView.updated_by')}
