...
import Customer_contactAddEditBaseView from './base';
...
const customer_contactPopupForm: FC<PopupFormProps> = observer((props) => {
  ...
  return (
    <Dialog open={props.openPanel} onClose={props.onBtnCancelClick} maxWidth="sm" fullWidth>
      <DialogTitle>{translate('label:customer_contactAddEditView.entityTitle')}</DialogTitle>
      <DialogContent>
...
export default customer_contactPopupForm
