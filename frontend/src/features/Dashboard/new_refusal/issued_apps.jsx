...
const RefusalCountByStructureDashboard = observer(() => {
  ...
  const columns = [
    {
      ...
      renderCell: (row) => {
        ...
        return <span><a onClick={() => {
          dashboardStore.selected_refusal_count_structure_id = row.structure_id - 0;
          dashboardStore.selected_refusal_count_structure_name = row.structure;
          // const json = `{}`
...
export default RefusalCountByStructureDashboard