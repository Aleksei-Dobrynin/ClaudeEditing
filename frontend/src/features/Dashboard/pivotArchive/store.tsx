...
import { getForArchivePivotDashboard } from "api/Dashboard";
  ...
  loadApplications = async () => {
    if (this.pivot_date_start?.isValid() && this.pivot_date_end?.isValid()) {
      try {
        ...
        const response = await getForArchivePivotDashboard(this.pivot_date_start, this.pivot_date_end?.add(1, 'day'));
