...
import { getForTaskPivotDashboard } from "api/Dashboard";
  ...
  loadApplications = async () => {
    if (this.pivot_date_start?.isValid() && this.pivot_date_end?.isValid()) {
      try {
        ...
        const response = await getForTaskPivotDashboard(this.pivot_date_start, this.pivot_date_end?.add(1, 'day'), this.pivot_out_of_date);
