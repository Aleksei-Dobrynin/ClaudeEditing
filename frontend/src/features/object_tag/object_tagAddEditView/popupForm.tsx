...
import Object_tagAddEditBaseView from './base';
...
const object_tagPopupForm: FC<PopupFormProps> = observer((props) => {
  ...
  return (
    <Dialog open={props.openPanel} onClose={props.onBtnCancelClick} maxWidth="sm" fullWidth>
      <DialogTitle>{translate('label:object_tagAddEditView.entityTitle')}</DialogTitle>
      <DialogContent>
...
export default object_tagPopupForm
