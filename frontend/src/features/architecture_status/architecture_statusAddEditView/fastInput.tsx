...
import storeList from "./../architecture_statusListView/store";
...
const FastInputView: FC<architecture_statusProps> = observer((props) => {
  ...
  useEffect(() => {
    if (props.idMain !== 0 && storeList.idMain !== props.idMain) {
      ...
      storeList.loadarchitecture_statuses();
    }
  }, [props.idMain]);
  ...
  const columns = [
    {
      ...
      headerName: translate("label:architecture_statusListView.updated_at"),
    },
    {
      field: 'created_by',
      width: null, //or number from 1 to 12
      headerName: translate("label:architecture_statusListView.created_by"),
    },
    {
      field: 'updated_by',
      width: null, //or number from 1 to 12
      headerName: translate("label:architecture_statusListView.updated_by"),
    },
    {
      field: 'name',
      width: null, //or number from 1 to 12
    ...
    },
    {
      field: 'created_at',
      width: null, //or number from 1 to 12
      headerName: translate("label:architecture_statusListView.created_at"),
    },
  ...
  return (
    <Container>
      <Card component={Paper} elevation={5}>
        <CardContent>
          <Box id="architecture_status_TitleName" sx={{ m: 1 }}>
            <h3>{translate("label:architecture_statusAddEditView.entityTitle")}</h3>
          </Box>
          <Divider />
                    ...
                    {storeList.isEdit === false && (
                      <>
                        ...
                        <IconButton
                          ...
                          onClick={() => storeList.deletearchitecture_status(entity.id)}
                        >
                          <DeleteIcon />
                        </IconButton>
                      </>
          ...
          {storeList.isEdit ? (
            <Grid container spacing={3} sx={{ mt: 2 }}>
              ...
              <Grid item md={12} xs={12}>
                <DateTimeField
                  ...
                  name="updated_at"
                  id='id_f_architecture_status_updated_at'
                  label={translate('label:architecture_statusAddEditView.updated_at')}
              ...
              <Grid item md={12} xs={12}>
                <CustomTextField
                  ...
                  onChange={(event) => store.handleChange(event)}
                  name="created_by"
                  data-testid="id_f_architecture_status_created_by"
                  id='id_f_architecture_status_created_by'
                  label={translate('label:architecture_statusAddEditView.created_by')}
              ...
              <Grid item md={12} xs={12}>
                <CustomTextField
                  ...
                  onChange={(event) => store.handleChange(event)}
                  name="updated_by"
                  data-testid="id_f_architecture_status_updated_by"
                  id='id_f_architecture_status_updated_by'
                  label={translate('label:architecture_statusAddEditView.updated_by')}
              ...
              <Grid item md={12} xs={12}>
                <DateTimeField
                  ...
                  onChange={(event) => store.handleChange(event)}
                  name="created_at"
                  id='id_f_architecture_status_created_at'
                  label={translate('label:architecture_statusAddEditView.created_at')}
            ...
            <Grid item display={"flex"} justifyContent={"flex-end"} sx={{ mt: 2 }}>
              <CustomButton
                variant="contained"
                size="small"
                id="id_architecture_statusAddButton"
                onClick={() => {
                  storeList.setFastInputIsEdit(true);
                  store.doLoad(0);
