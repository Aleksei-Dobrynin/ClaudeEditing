...
import Architecture_statusAddEditBaseView from './base';
...
const architecture_statusPopupForm: FC<PopupFormProps> = observer((props) => {
  ...
  return (
    <Dialog open={props.openPanel} onClose={props.onBtnCancelClick} maxWidth="sm" fullWidth>
      <DialogTitle>{translate('label:architecture_statusAddEditView.entityTitle')}</DialogTitle>
      <DialogContent>
...
export default architecture_statusPopupForm
