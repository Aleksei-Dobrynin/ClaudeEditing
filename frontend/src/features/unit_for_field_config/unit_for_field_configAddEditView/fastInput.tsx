...
import storeList from "./../unit_for_field_configListView/store";
...
const FastInputView: FC<unit_for_field_configProps> = observer((props) => {
  ...
  useEffect(() => {
    if (props.idMain !== 0 && storeList.idMain !== props.idMain) {
      ...
      storeList.loadunit_for_field_configs();
    }
  }, [props.idMain]);
  ...
  return (
    <Container>
      <Card component={Paper} elevation={5}>
        <CardContent>
          <Box id="unit_for_field_config_TitleName" sx={{ m: 1 }}>
            <h3>{translate("label:unit_for_field_configAddEditView.entityTitle")}</h3>
          </Box>
          <Divider />
                    ...
                    {storeList.isEdit === false && (
                      <>
                        ...
                        <IconButton
                          ...
                          onClick={() => storeList.deleteunit_for_field_config(entity.id)}
                        >
                          <DeleteIcon />
                        </IconButton>
                      </>
          ...
          {storeList.isEdit ? (
            <Grid container spacing={3} sx={{ mt: 2 }}>
                  ...
                  <Grid item md={12} xs={12}>
                    <CustomTextField
                      ...
                      name="unit_id"
                      data-testid="id_f_unit_for_field_config_unit_id"
                      id='id_f_unit_for_field_config_unit_id'
                  ...
                  <Grid item md={12} xs={12}>
                    <CustomTextField
                      ...
                      onChange={(event) => store.handleChange(event)}
                      name="field_id"
                      data-testid="id_f_unit_for_field_config_field_id"
            ...
            <Grid item display={"flex"} justifyContent={"flex-end"} sx={{ mt: 2 }}>
              <CustomButton
                variant="contained"
                size="small"
                id="id_unit_for_field_configAddButton"
                onClick={() => {
                  storeList.setFastInputIsEdit(true);
                  store.doLoad(0);
