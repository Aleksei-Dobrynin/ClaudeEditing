...
import Status_dutyplan_objectAddEditBaseView from './base';
...
const status_dutyplan_objectPopupForm: FC<PopupFormProps> = observer((props) => {
  ...
  return (
    <Dialog open={props.openPanel} onClose={props.onBtnCancelClick} maxWidth="sm" fullWidth>
      <DialogTitle>{translate('label:status_dutyplan_objectAddEditView.entityTitle')}</DialogTitle>
      <DialogContent>
...
export default status_dutyplan_objectPopupForm
