...
import NotificationLogStatusAddEditBaseView from './base';
...
const notificationLogStatusPopupForm: FC<PopupFormProps> = observer((props) => {
  ...
  return (
    <Dialog open={props.openPanel} onClose={props.onBtnCancelClick} maxWidth="sm" fullWidth>
      <DialogTitle>{translate('label:notificationLogStatusAddEditView.entityTitle')}</DialogTitle>
      <DialogContent>
...
export default notificationLogStatusPopupForm
