...
import { deleteidentity_document_type } from "api/identity_document_type";
...
class NewStore {
  ...
  async loadidentity_document_types() {
    try {
  ...
  deleteidentity_document_type(id: number) {
    MainStore.openErrorConfirm(
      ...
      async () => {
        try {
          MainStore.changeLoader(true);
          const response = await deleteidentity_document_type(id);
