...
import Faq_questionAddEditBaseView from './base';
...
const faq_questionPopupForm: FC<PopupFormProps> = observer((props) => {
  ...
  return (
    <Dialog open={props.openPanel} onClose={props.onBtnCancelClick} maxWidth="sm" fullWidth>
      <DialogTitle>{translate('label:faq_questionAddEditView.entityTitle')}</DialogTitle>
      <DialogContent>
...
export default faq_questionPopupForm
