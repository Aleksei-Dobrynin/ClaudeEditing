...
import Application_in_reestrAddEditBaseView from './base';
...
const application_in_reestrPopupForm: FC<PopupFormProps> = observer((props) => {
  ...
  return (
    <Dialog open={props.openPanel} onClose={props.onBtnCancelClick} maxWidth="sm" fullWidth>
      <DialogTitle>{translate('label:application_in_reestrAddEditView.entityTitle')}</DialogTitle>
      <DialogContent>
...
export default application_in_reestrPopupForm
