...
export const schema = yup.object().shape({
  ...
  dependent_step_id: yup.number().notOneOf([0], "Required field").required("Required field"),
  prerequisite_step_id: yup.number().notOneOf([0], "Required field").required("Required field"),
  is_strict: yup.boolean().default(false),
});
