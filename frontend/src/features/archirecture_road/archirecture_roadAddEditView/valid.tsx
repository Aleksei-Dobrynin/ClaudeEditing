...
export const schema = yup.object().shape({
  rule_expression: yup.string(),
  is_active: yup.boolean().default(false),
  from_status_id: yup.number().notOneOf([0], "Required field").required("Required field"),
  to_status_id: yup.number().notOneOf([0], "Required field").required("Required field"),
});
