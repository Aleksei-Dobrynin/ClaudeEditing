...
import storeList from "./../contact_typeListView/store";
...
const FastInputView: FC<contact_typeProps> = observer((props) => {
  ...
  const columns = [
    {
                ...
                },
                {
                    field: 'additional',
                    width: null, //or number from 1 to 12
                    headerName: translate("label:SmProjectTagListView.additional"),
                },
  ...
  return (
    <Container>
      <Card component={Paper} elevation={5}>
        <CardContent>
          <Box id="contact_type_TitleName" sx={{ m: 1 }}>
            <h3>{translate("label:contact_typeAddEditView.entityTitle")}</h3>
          </Box>
          <Divider />
                    ...
                    {storeList.isEdit === false && (
                      <>
                        ...
                        <IconButton
                          ...
                          onClick={() => storeList.deletecontact_type(entity.id)}
                        >
                          <DeleteIcon />
                        </IconButton>
                      </>
