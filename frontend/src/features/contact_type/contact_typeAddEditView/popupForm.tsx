...
import Contact_typeAddEditBaseView from './base';
...
const contact_typePopupForm: FC<PopupFormProps> = observer((props) => {
  ...
  return (
    <Dialog open={props.openPanel} onClose={props.onBtnCancelClick} maxWidth="sm" fullWidth>
      <DialogTitle>{translate('label:contact_typeAddEditView.entityTitle')}</DialogTitle>
      <DialogContent>
...
export default contact_typePopupForm
