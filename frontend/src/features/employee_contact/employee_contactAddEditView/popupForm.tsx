...
import Employee_contactAddEditBaseView from './base';
...
const Employee_contactPopupForm: FC<PopupFormProps> = observer((props) => {
  ...
  return (
    <Dialog open={props.openPanel} onClose={props.onBtnCancelClick} maxWidth="sm" fullWidth>
      <DialogTitle>{translate('label:employee_contactAddEditView.entityTitle')}</DialogTitle>
      <DialogContent>
...
export default Employee_contactPopupForm
