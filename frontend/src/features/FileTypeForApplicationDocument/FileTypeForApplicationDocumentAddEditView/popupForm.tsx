...
import FileTypeForApplicationDocumentAddEditBaseView from './base';
...
const PopupForm: FC<PopupFormProps> = observer((props) => {
  ...
  return (
    <Dialog open={props.openPanel} onClose={props.onBtnCancelClick}>
      <DialogTitle>{translate('label:FileTypeForApplicationDocumentAddEditView.entityTitle')}</DialogTitle>
      <DialogContent>
