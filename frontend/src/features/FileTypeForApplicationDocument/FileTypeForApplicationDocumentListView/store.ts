...
import { deleteFileTypeForApplicationDocument } from "api/FileTypeForApplicationDocument/useDeleteFileTypeForApplicationDocument";
...
class NewStore {
  ...
  deleteFileTypeForApplicationDocument = (id: number) => {
    MainStore.openErrorConfirm(
      ...
      async () => {
        try {
          MainStore.changeLoader(true);
          const response = await deleteFileTypeForApplicationDocument(id);
