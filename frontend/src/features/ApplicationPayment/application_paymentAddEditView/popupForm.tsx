...
import Application_paymentAddEditBaseView from './base';
...
const application_paymentPopupForm: FC<PopupFormProps> = observer((props) => {
  ...
  return (
    <Dialog open={props.openPanel} onClose={props.onBtnCancelClick} maxWidth="sm" fullWidth>
      <DialogTitle>{translate('label:application_paymentAddEditView.entityTitle')}</DialogTitle>
      <DialogContent>
...
export default application_paymentPopupForm
