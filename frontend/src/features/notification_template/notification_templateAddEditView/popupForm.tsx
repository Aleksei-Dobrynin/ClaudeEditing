...
import Notification_templateAddEditBaseView from './base';
...
const notification_templatePopupForm: FC<PopupFormProps> = observer((props) => {
  ...
  return (
    <Dialog open={props.openPanel} onClose={props.onBtnCancelClick} maxWidth="sm" fullWidth>
      <DialogTitle>{translate('label:notification_templateAddEditView.entityTitle')}</DialogTitle>
      <DialogContent>
...
export default notification_templatePopupForm
