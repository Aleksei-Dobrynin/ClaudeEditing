...
import Application_subtask_assigneeAddEditBaseView from './base';
...
const application_subtask_assigneePopupForm: FC<PopupFormProps> = observer((props) => {
...
export default application_subtask_assigneePopupForm
