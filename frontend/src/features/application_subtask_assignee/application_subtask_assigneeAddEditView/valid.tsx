...
export const schema = yup.object().shape({
  ...
  structure_employee_id: yup.number().notOneOf([0], "Required field").required("Required field"),
  application_subtask_id: yup.number().notOneOf([0], "Required field").required("Required field"),
});
