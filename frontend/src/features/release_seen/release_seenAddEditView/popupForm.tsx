...
import Release_seenAddEditBaseView from './base';
...
const release_seenPopupForm: FC<PopupFormProps> = observer((props) => {
  ...
  return (
    <Dialog open={props.openPanel} onClose={props.onBtnCancelClick} maxWidth="sm" fullWidth>
      <DialogTitle>{translate('label:release_seenAddEditView.entityTitle')}</DialogTitle>
      <DialogContent>
...
export default release_seenPopupForm
