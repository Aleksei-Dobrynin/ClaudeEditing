...
import storeList from "./../release_seenListView/store";
...
const FastInputView: FC<release_seenProps> = observer((props) => {
  ...
  const columns = [
    {
      ...
      headerName: translate("label:release_seenListView.release_id"),
    },
    {
      field: 'user_id',
      width: null, //or number from 1 to 12
  ...
  return (
    <Container>
      <Card component={Paper} elevation={5}>
        <CardContent>
          <Box id="release_seen_TitleName" sx={{ m: 1 }}>
            <h3>{translate("label:release_seenAddEditView.entityTitle")}</h3>
          </Box>
          <Divider />
                    ...
                    {storeList.isEdit === false && (
                      <>
                        ...
                        <IconButton
                          ...
                          onClick={() => storeList.deleterelease_seen(entity.id)}
                        >
                          <DeleteIcon />
                        </IconButton>
                      </>
            ...
            <Grid container spacing={3} sx={{ mt: 2 }}>
              ...
              <Grid item md={12} xs={12}>
                <DateTimeField
                  ...
                  onChange={(event) => store.handleChange(event)}
                  name="created_at"
                  id='id_f_release_seen_created_at'
                  label={translate('label:release_seenAddEditView.created_at')}
              ...
              <Grid item md={12} xs={12}>
                <DateTimeField
                  ...
                  onChange={(event) => store.handleChange(event)}
                  name="updated_at"
                  id='id_f_release_seen_updated_at'
                  label={translate('label:release_seenAddEditView.updated_at')}
              ...
              <Grid item md={12} xs={12}>
                <CustomTextField
                  ...
                  onChange={(event) => store.handleChange(event)}
                  name="created_by"
                  data-testid="id_f_release_seen_created_by"
                  id='id_f_release_seen_created_by'
                  label={translate('label:release_seenAddEditView.created_by')}
              ...
              <Grid item md={12} xs={12}>
                <CustomTextField
                  ...
                  onChange={(event) => store.handleChange(event)}
                  name="updated_by"
                  data-testid="id_f_release_seen_updated_by"
                  id='id_f_release_seen_updated_by'
                  label={translate('label:release_seenAddEditView.updated_by')}
