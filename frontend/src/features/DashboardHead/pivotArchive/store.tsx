...
import { getForArchivePivotDashboard, getForArchivePivotDashboardMyStructure } from "api/Dashboard";
  ...
  loadApplications = async () => {
    if (this.pivot_date_start?.isValid() && this.pivot_date_end?.isValid()) {
      try {
        ...
        const response = await getForArchivePivotDashboardMyStructure(this.pivot_date_start, this.pivot_date_end?.add(1, 'day'));
