  ...
  return (
    <Paper elevation={2} sx={{ p: 2, height: '100%' }}>
      <Grid container spacing={2}>
        <Button onClick={()=>{
          dashboardStore.selected_count_structure_id = 0;
          dashboardStore.selected_count_structure_name = '';
        }}>Назад</Button>
        <Grid item xs={12} md={12} display={"flex"} justifyContent={"center"}>
          <h2>
            {translate("Заявки за период по отделу: ") + dashboardStore.selected_count_structure_name}
          </h2>
        </Grid>
