    ...
    <Paper elevation={2} sx={{ p: 2, height: '100%' }}>
      <Grid container spacing={2}>
        ...
        <Grid item xs={12} md={3}>
          <DateField
            value={store.finance_date_start}
            onChange={(event) => store.changeFinance(event)}
            name="finance_date_start"
            id="id_f_finance_date_start"
            label={translate("label:Dashboard.startDate")}
          />
        </Grid>
        <Grid item xs={12} md={3}>
          <DateField
            value={store.finance_date_end}
            onChange={(event) => store.changeFinance(event)}
            name="finance_date_end"
            id="id_f_finance_date_end"
