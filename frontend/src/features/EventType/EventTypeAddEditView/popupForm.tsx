...
import Event_typeAddEditBaseView from './base';
...
const event_typePopupForm: FC<PopupFormProps> = observer((props) => {
  ...
  return (
    <Dialog open={props.openPanel} onClose={props.onBtnCancelClick} maxWidth="sm" fullWidth>
      <DialogTitle>{translate('label:event_typeAddEditView.entityTitle')}</DialogTitle>
      <DialogContent>
...
export default event_typePopupForm