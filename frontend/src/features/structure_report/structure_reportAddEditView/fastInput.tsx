...
import storeList from "./../structure_reportListView/store";
...
const FastInputView: FC<structure_reportProps> = observer((props) => {
  ...
  useEffect(() => {
    if (props.idMain !== 0 && storeList.idMain !== props.idMain) {
      ...
      storeList.loadstructure_reports();
    }
  }, [props.idMain]);
  ...
  return (
    <Container>
      <Card component={Paper} elevation={5}>
        <CardContent>
          <Box id="structure_report_TitleName" sx={{ m: 1 }}>
            <h3>{translate("label:structure_reportAddEditView.entityTitle")}</h3>
          </Box>
          <Divider />
                    ...
                    {storeList.isEdit === false && (
                      <>
                        ...
                        <IconButton
                          ...
                          onClick={() => storeList.deletestructure_report(entity.id)}
                        >
                          <DeleteIcon />
                        </IconButton>
                      </>
          ...
          {storeList.isEdit ? (
            <Grid container spacing={3} sx={{ mt: 2 }}>
                  ...
                  <Grid item md={12} xs={12}>
                    <CustomTextField
                      ...
                      data-testid="id_f_structure_report_report_config_id"
                      id='id_f_structure_report_report_config_id'
                      label={translate('label:structure_reportAddEditView.report_config_id')}
                      helperText={store.errors.report_config_id}
                      error={!!store.errors.report_config_id}
                    />
                  </Grid>
                  {/* <Grid item md={12} xs={12}>
                    <DateTimeField
            ...
            <Grid item display={"flex"} justifyContent={"flex-end"} sx={{ mt: 2 }}>
              <CustomButton
                variant="contained"
                size="small"
                id="id_structure_reportAddButton"
                onClick={() => {
                  storeList.setFastInputIsEdit(true);
                  store.doLoad(0);
