...
import storeList from "./../application_duty_objectListView/store";
...
const FastInputView: FC<application_duty_objectProps> = observer((props) => {
  ...
  useEffect(() => {
    if (props.idMain !== 0 && storeList.idMain !== props.idMain) {
      ...
      storeList.loadapplication_duty_objects();
    }
  }, [props.idMain]);
  ...
  return (
    <Container>
      <Card component={Paper} elevation={5}>
        <CardContent>
          <Box id="application_duty_object_TitleName" sx={{ m: 1 }}>
            <h3>{translate("label:application_duty_objectAddEditView.entityTitle")}</h3>
          </Box>
          <Divider />
                    ...
                    {storeList.isEdit === false && (
                      <>
                        ...
                        <IconButton
                          ...
                          onClick={() => storeList.deleteapplication_duty_object(entity.id)}
                        >
                          <DeleteIcon />
                        </IconButton>
                      </>
          ...
          {storeList.isEdit ? (
            ...
            <Grid item display={"flex"} justifyContent={"flex-end"} sx={{ mt: 2 }}>
              <CustomButton
                variant="contained"
                size="small"
                id="id_application_duty_objectAddButton"
                onClick={() => {
                  storeList.setFastInputIsEdit(true);
                  store.doLoad(0);
