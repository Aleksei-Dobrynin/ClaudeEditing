...
import storeList from "./../structure_report_configListView/store";
...
const FastInputView: FC<structure_report_configProps> = observer((props) => {
  ...
  useEffect(() => {
    if (props.idMain !== 0 && storeList.idMain !== props.idMain) {
      ...
      storeList.loadstructure_report_configs();
    }
  }, [props.idMain]);
  ...
  return (
    <Container>
      <Card component={Paper} elevation={5}>
        <CardContent>
          <Box id="structure_report_config_TitleName" sx={{ m: 1 }}>
            <h3>{translate("label:structure_report_configAddEditView.entityTitle")}</h3>
          </Box>
          <Divider />
                    ...
                    {storeList.isEdit === false && (
                      <>
                        ...
                        <IconButton
                          ...
                          onClick={() => storeList.deletestructure_report_config(entity.id)}
                        >
                          <DeleteIcon />
                        </IconButton>
                      </>
          ...
          {storeList.isEdit ? (
            <Grid container spacing={3} sx={{ mt: 2 }}>
                  ...
                  <Grid item md={12} xs={12}>
                    <CustomTextField
                      ...
                      name="structure_id"
                      data-testid="id_f_structure_report_config_structure_id"
                      id='id_f_structure_report_config_structure_id'
                      label={translate('label:structure_report_configAddEditView.structure_id')}
            ...
            <Grid item display={"flex"} justifyContent={"flex-end"} sx={{ mt: 2 }}>
              <CustomButton
                variant="contained"
                size="small"
                id="id_structure_report_configAddButton"
                onClick={() => {
                  storeList.setFastInputIsEdit(true);
                  store.doLoad(0);
