...
import Release_videoAddEditBaseView from './base';
...
const release_videoPopupForm: FC<PopupFormProps> = observer((props) => {
  ...
  return (
    <Dialog open={props.openPanel} onClose={props.onBtnCancelClick} maxWidth="sm" fullWidth>
      <DialogTitle>{translate('label:release_videoAddEditView.entityTitle')}</DialogTitle>
      <DialogContent>
...
export default release_videoPopupForm
