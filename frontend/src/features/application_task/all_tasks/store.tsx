...
import { deleteapplication_task, getapplication_tasks, getAllTasks, getStructureTasks } from "api/application_task";
...
class NewStore {
  ...
  async loadapplication_tasks() {
    try {
      ...
      const response = await getAllTasks(this.searchField, this.date_start, this.date_end, this.page, this.pageSize);
