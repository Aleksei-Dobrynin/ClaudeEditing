...
class NewStore {
  ...
  async loadapplication_tasks() {
    try {
      ...
      const response = this.my_tasks ? await getMyTasks(this.searchField, this.date_start, this.date_end, this.isExpiredTasks, this.isResolwedTasks) : await getStructureTasks(this.searchField, this.date_start, this.date_end, this.isExpiredTasks, this.isResolwedTasks);
