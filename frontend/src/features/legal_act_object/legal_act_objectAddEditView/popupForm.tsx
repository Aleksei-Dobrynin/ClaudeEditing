...
import Baselegal_act_objectView from './base';
...
const Legal_act_objectPopupForm: FC<PopupFormProps> = observer((props) => {
  ...
  return (
    <Dialog open={props.openPanel} onClose={props.onBtnCancelClick} maxWidth="sm" fullWidth>
      <DialogTitle>{translate('label:legal_act_objectAddEditView.entityTitle')}</DialogTitle>
      <DialogContent>
...
export default Legal_act_objectPopupForm
