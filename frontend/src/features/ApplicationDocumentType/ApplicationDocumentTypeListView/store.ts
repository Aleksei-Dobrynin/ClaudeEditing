...
import { deleteApplicationDocumentType } from "api/ApplicationDocumentType/useDeleteApplicationDocumentType";
...
class NewStore {
  ...
  deleteApplicationDocumentType = (id: number) => {
    MainStore.openErrorConfirm(
      ...
      async () => {
        try {
          MainStore.changeLoader(true);
          const response = await deleteApplicationDocumentType(id);
