...
import Work_scheduleAddEditBaseView from './base';
...
const work_schedulePopupForm: FC<PopupFormProps> = observer((props) => {
  ...
  return (
    <Dialog open={props.openPanel} onClose={props.onBtnCancelClick} maxWidth="sm" fullWidth>
      <DialogTitle>{translate('label:work_scheduleAddEditView.entityTitle')}</DialogTitle>
      <DialogContent>
...
export default work_schedulePopupForm
