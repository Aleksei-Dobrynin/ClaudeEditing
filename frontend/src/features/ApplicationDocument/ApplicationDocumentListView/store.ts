...
import { deleteApplicationDocument } from "api/ApplicationDocument/useDeleteApplicationDocument";
...
class NewStore {
  ...
  deleteApplicationDocument = (id: number) => {
    MainStore.openErrorConfirm(
      ...
      async () => {
        try {
          MainStore.changeLoader(true);
          const response = await deleteApplicationDocument(id);
