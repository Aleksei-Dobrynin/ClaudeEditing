...
import storeList from "./../SmProjectTagListView/store";
import CreateIcon from "@mui/icons-material/Create";
import DeleteIcon from "@mui/icons-material/Delete";
import CustomButton from "components/Button";

type SmProjectTagProps = {
  children?: React.ReactNode;
  isPopup?: boolean;
  idMain: number;
};

const FastInputView: FC<SmProjectTagProps> = observer((props) => {
  ...
  return (
    <Container>
      <Card component={Paper} elevation={5}>
        <CardContent>
          <Box id="SmProjectTag_TitleName" sx={{ m: 1 }}>
            <h3>{translate("label:SmProjectTagAddEditView.entityTitle")}</h3>
          </Box>
          <Divider />
                    ...
                    {storeList.isEdit === false && (
                      <>
                        ...
                        <IconButton
                          ...
                          onClick={() => storeList.deleteSmProjectTag(entity.id)}
                        >
                          <DeleteIcon />
                        </IconButton>
                      </>
