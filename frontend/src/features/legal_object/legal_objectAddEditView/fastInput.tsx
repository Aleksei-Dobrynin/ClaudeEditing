...
import storeList from "./../legal_objectListView/store";
...
const FastInputView: FC<legal_objectProps> = observer((props) => {
  ...
  return (
    <Container>
      <Card component={Paper} elevation={5}>
        <CardContent>
          <Box id="legal_object_TitleName" sx={{ m: 1 }}>
            <h3>{translate("label:legal_objectAddEditView.entityTitle")}</h3>
          </Box>
          <Divider />
                    ...
                    {storeList.isEdit === false && (
                      <>
                        ...
                        <IconButton
                          ...
                          onClick={() => storeList.deletelegal_object(entity.id)}
                        >
                          <DeleteIcon />
                        </IconButton>
                      </>
            ...
            <Grid container spacing={3} sx={{ mt: 2 }}>
                  ...
                  <Grid item md={12} xs={12}>
                    <DateTimeField
                      ...
                      onChange={(event) => store.handleChange(event)}
                      name="created_at"
                      id='id_f_legal_object_created_at'
                      label={translate('label:legal_objectAddEditView.created_at')}
                  ...
                  <Grid item md={12} xs={12}>
                    <DateTimeField
                      ...
                      onChange={(event) => store.handleChange(event)}
                      name="updated_at"
                      id='id_f_legal_object_updated_at'
                      label={translate('label:legal_objectAddEditView.updated_at')}
                  ...
                  <Grid item md={12} xs={12}>
                    <CustomTextField
                      ...
                      onChange={(event) => store.handleChange(event)}
                      name="created_by"
                      data-testid="id_f_legal_object_created_by"
                      id='id_f_legal_object_created_by'
                      label={translate('label:legal_objectAddEditView.created_by')}
                  ...
                  <Grid item md={12} xs={12}>
                    <CustomTextField
                      ...
                      onChange={(event) => store.handleChange(event)}
                      name="updated_by"
                      data-testid="id_f_legal_object_updated_by"
                      id='id_f_legal_object_updated_by'
                      label={translate('label:legal_objectAddEditView.updated_by')}
