...
import Archive_doc_tagAddEditBaseView from './base';
...
const archive_doc_tagPopupForm: FC<PopupFormProps> = observer((props) => {
  ...
  return (
    <Dialog open={props.openPanel} onClose={props.onBtnCancelClick} maxWidth="sm" fullWidth>
      <DialogTitle>{translate('label:archive_doc_tagAddEditView.entityTitle')}</DialogTitle>
      <DialogContent>
...
export default archive_doc_tagPopupForm
