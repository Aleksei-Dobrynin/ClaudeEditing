...
import storeList from "./../archive_doc_tagListView/store";
...
const FastInputView: FC<archive_doc_tagProps> = observer((props) => {
  ...
  useEffect(() => {
    if (props.idMain !== 0 && storeList.idMain !== props.idMain) {
      ...
      storeList.loadarchive_doc_tags();
    }
  }, [props.idMain]);
  ...
  return (
    <Container>
      <Card component={Paper} elevation={5}>
        <CardContent>
          <Box id="archive_doc_tag_TitleName" sx={{ m: 1 }}>
            <h3>{translate("label:archive_doc_tagAddEditView.entityTitle")}</h3>
          </Box>
          <Divider />
                    ...
                    {storeList.isEdit === false && (
                      <>
                        ...
                        <IconButton
                          ...
                          onClick={() => storeList.deletearchive_doc_tag(entity.id)}
                        >
                          <DeleteIcon />
                        </IconButton>
                      </>
          ...
          {storeList.isEdit ? (
            ...
            <Grid item display={"flex"} justifyContent={"flex-end"} sx={{ mt: 2 }}>
              <CustomButton
                variant="contained"
                size="small"
                id="id_archive_doc_tagAddButton"
                onClick={() => {
                  storeList.setFastInputIsEdit(true);
                  store.doLoad(0);
