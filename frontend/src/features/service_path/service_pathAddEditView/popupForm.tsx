...
import Service_pathAddEditBaseView from './base';
...
const service_pathPopupForm: FC<PopupFormProps> = observer((props) => {
  ...
  return (
    <Dialog open={props.openPanel} onClose={props.onBtnCancelClick} maxWidth="sm" fullWidth>
      <DialogTitle>{translate('label:service_pathAddEditView.entityTitle')}</DialogTitle>
      <DialogContent>
...
export default service_pathPopupForm
