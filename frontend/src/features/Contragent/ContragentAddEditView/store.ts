...
import { getContragent } from "api/Contragent/useGetContragent";
import { saveContragent } from "api/Contragent/useSaveContragent";
  ...
  onSaveClick = async (onSaved: (id: number) => void) => {
    ...
    if (canSave) {
      try {
        ...
        const response = await saveContragent(data);
