...
const Structure_report_statusListView: FC<structure_report_statusListViewProps> = observer((props) => {
  ...
  const columns: GridColDef[] = [
    
    {
      ...
      flex: 1,
      renderCell: (param) => (<div data-testid="table_structure_report_status_column_created_at"> {param.row.createdAt} </div>),
    ...
    },
    {
      ...
      flex: 1,
      renderCell: (param) => (<div data-testid="table_structure_report_status_column_updated_at"> {param.row.updatedAt} </div>),
    ...
    },
    {
      ...
      flex: 1,
      renderCell: (param) => (<div data-testid="table_structure_report_status_column_created_by"> {param.row.createdBy} </div>),
    ...
    },
    {
      ...
      flex: 1,
      renderCell: (param) => (<div data-testid="table_structure_report_status_column_updated_by"> {param.row.updatedBy} </div>),
