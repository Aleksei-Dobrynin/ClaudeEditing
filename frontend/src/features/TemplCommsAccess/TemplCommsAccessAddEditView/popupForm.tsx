...
import TemplCommsAccessAddEditBaseView from './base';
...
const TemplCommsAccessPopupForm: FC<PopupFormProps> = observer((props) => {
  ...
  return (
    <Dialog open={props.openPanel} onClose={props.onBtnCancelClick} maxWidth="sm" fullWidth>
      <DialogTitle>{translate('label:TemplCommsAccessAddEditView.entityTitle')}</DialogTitle>
      <DialogContent>
...
export default TemplCommsAccessPopupForm
