...
import Task_statusAddEditBaseView from './base';
...
const task_statusPopupForm: FC<PopupFormProps> = observer((props) => {
  ...
  return (
    <Dialog open={props.openPanel} onClose={props.onBtnCancelClick} maxWidth="sm" fullWidth>
      <DialogTitle>{translate('label:task_statusAddEditView.entityTitle')}</DialogTitle>
      <DialogContent>
...
export default task_statusPopupForm
