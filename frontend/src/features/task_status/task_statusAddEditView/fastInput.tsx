...
import storeList from "./../task_statusListView/store";
...
const FastInputView: FC<task_statusProps> = observer((props) => {
  ...
  return (
    <Container>
      <Card component={Paper} elevation={5}>
        <CardContent>
          <Box id="task_status_TitleName" sx={{ m: 1 }}>
            <h3>{translate("label:task_statusAddEditView.entityTitle")}</h3>
          </Box>
          <Divider />
                    ...
                    {storeList.isEdit === false && (
                      <>
                        ...
                        <IconButton
                          ...
                          onClick={() => storeList.deletetask_status(entity.id)}
                        >
                          <DeleteIcon />
                        </IconButton>
                      </>
