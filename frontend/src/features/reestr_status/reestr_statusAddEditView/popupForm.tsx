...
import Reestr_statusAddEditBaseView from './base';
...
const reestr_statusPopupForm: FC<PopupFormProps> = observer((props) => {
  ...
  return (
    <Dialog open={props.openPanel} onClose={props.onBtnCancelClick} maxWidth="sm" fullWidth>
      <DialogTitle>{translate('label:reestr_statusAddEditView.entityTitle')}</DialogTitle>
      <DialogContent>
...
export default reestr_statusPopupForm
