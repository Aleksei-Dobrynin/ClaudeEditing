...
import { default as ArchObjectAddEditBaseView } from './base'
...
const ArchObjectAddEditView: FC<ArchObjectProps> = observer((props) => {
  ...
  return (
    <ArchObjectAddEditBaseView {...props}>
      ...
      <Box display="flex" p={2}>
        ...
        <Box m={2}>
          <CustomButton
            ...
            onClick={() => navigate('/user/ArchObject')}
          >
...
export default ArchObjectAddEditView