...
import { getApplicationStatus } from "api/ApplicationStatus/useGetApplicationStatus";
import { saveApplicationStatus } from "api/ApplicationStatus/useSaveApplicationStatus";
  ...
  onSaveClick = async (onSaved: (id: number) => void) => {
    ...
    if (canSave) {
      try {
        ...
        const response = await saveApplicationStatus(data);
