...
export const schema = yup.object().shape({
  ...
  id_application: yup.number().notOneOf([0], "Required field").required("Required field"),
  id_legalrecord: yup.number().notOneOf([0], "Required field").required("Required field"),
  id_legalact: yup.number().notOneOf([0], "Required field").required("Required field"),
  created_at: yup
    .date()
    .nullable()
