...
import Tech_decisionAddEditBaseView from './base';
...
const tech_decisionPopupForm: FC<PopupFormProps> = observer((props) => {
  ...
  return (
    <Dialog open={props.openPanel} onClose={props.onBtnCancelClick} maxWidth="sm" fullWidth>
      <DialogTitle>{translate('label:tech_decisionAddEditView.entityTitle')}</DialogTitle>
      <DialogContent>
...
export default tech_decisionPopupForm
