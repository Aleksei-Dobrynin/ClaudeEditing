...
import Step_partnerAddEditBaseView from './base';
...
const step_partnerPopupForm: FC<PopupFormProps> = observer((props) => {
  ...
  return (
    <Dialog open={props.openPanel} onClose={props.onBtnCancelClick} maxWidth="sm" fullWidth>
      <DialogTitle>{translate('label:step_partnerAddEditView.entityTitle')}</DialogTitle>
      <DialogContent>
...
export default step_partnerPopupForm