...
import { getDiscountType, createDiscountType, updateDiscountType } from "api/DiscountType";
...
class NewStore {
  ...
  loadDiscountType = async (id: number) => {
    try {
      MainStore.changeLoader(true);
