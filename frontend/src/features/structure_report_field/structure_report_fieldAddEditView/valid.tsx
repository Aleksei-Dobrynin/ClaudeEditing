...
export const schema = yup.object().shape({
  ...
  // report_id: yup.number().notOneOf([0], "Required field").required("Required field"),
  // field_id: yup.number().notOneOf([0], "Required field").required("Required field"),
  // unit_id: yup.number().notOneOf([0], "Required field").required("Required field"),
  // value: yup.number().notOneOf([0], "Required field").required("Required field"),
  // created_at: yup
  //   .date()
  //   .nullable()
