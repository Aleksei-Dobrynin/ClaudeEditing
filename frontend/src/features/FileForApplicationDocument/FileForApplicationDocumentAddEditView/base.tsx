  ...
  return (
    <Container maxWidth='xl' style={{ marginTop: 20 }}>
      <Grid container>
        ...
        <form id="FileForApplicationDocumentForm" autoComplete='off'>
          <Paper elevation={7}  >
            <Card>
              <CardHeader title={
                <span id="FileForApplicationDocument_TitleName">
                  {translate('label:FileForApplicationDocumentAddEditView.entityTitle')}
                </span>
              } />
              <Divider />
              <CardContent>
                <Grid container spacing={3}>
                  <Grid item md={12} xs={12}>
                    <CustomTextField
                      ...
                      id='id_f_FileForApplicationDocument_name'
                      label={translate('label:FileForApplicationDocumentAddEditView.name')}
                      value={store.name}
                  ...
                  <Grid item md={12} xs={12}>
                    <LookUp
                      ...
                      data={store.Types}
                      id='id_f_type_id'
                      label={translate('label:FileForApplicationDocumentAddEditView.type_id')}
