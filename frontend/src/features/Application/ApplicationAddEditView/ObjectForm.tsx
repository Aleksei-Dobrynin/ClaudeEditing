...
import { Box, CircularProgress, Grid, IconButton, Paper, Tooltip, ClickAwayListener } from "@mui/material";
                ...
                <ClickAwayListener onClickAway={() => {
                  ...
                  <Paper elevation={1} sx={{ p: 2 }}>
                    ...
                    <Grid container spacing={1}>
                      ...
                      <Grid item md={12} xs={12}>
                        <Autocomplete
                          key={`${obj.random_key}_${obj.tunduk_street_id}_${obj.tunduk_district_id}_${obj.tunduk_address_unit_id}`}
